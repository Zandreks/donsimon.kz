...
export default class EditTovar extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            inptitle:'',
    ...
    componentWillMount(){
        ...
        axios.post('/admin/edittovar',{
            id:this.props.match.params.id
        })
            .then((response)=> {
                this.setState({
                    inptitle:response.data.title,
                    inpart:response.data.articl,
                    inpproiz:response.data.proezvod,
                    inpcount:response.data.cuntry,
                    inpob:response.data.obem,
                    inpyp:response.data.ypakovka,
                    inpsrok:response.data.srok,
    ...
    list(){
        const list = this.state.category.map(number=>
            <option key={number.id}  value={number.id} >{number.title}</option>
                            ...
                            <form onSubmit={this.submitform}  encType="multipart/form-data">
                                ...
                                <div className="form-row">
                                    <div className="col-md-4 mb-3">
                                        ...
                                        <input type="text" onChange={this.oncgangetitle} className={`form-control ${this.state.invtitle}`} id="title"
                                               placeholder="Наименование товара" value={this.state.inptitle} />
                                    ...
                                    <div className="col-md-4 mb-3">
                                        ...
                                        <input type="text" onChange={this.oncgangeart} className={`form-control ${this.state.invart}`} id="artikle"
                                               placeholder="Артикул" value={this.state.inpart} />
                                        <div className={this.state.clasart}>
                                            {this.state.erorart}
                                        </div>
                                    </div>
                                    <div className="col-md-4 mb-3">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="text" onChange={this.oncgangeproiz} className={`form-control ${this.state.invproiz}`}
                                                   id="proiz" value={this.state.inpproiz} placeholder="Производитель"
                                            />
                                            <div className={this.state.clasproiz}>
                                                {this.state.erorproiz}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-row">
                                    <div className="col-md-3 mb-3">
                                        ...
                                        <input type="text" className={`form-control ${this.state.invcount}`} onChange={this.oncgangecount} id="country"
                                               placeholder="Страна производства" value={this.state.inpcount} />
                                        <div className={this.state.clascount}>
                                            {this.state.erorcount}
                                        </div>
                                    </div>
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="obem">Объем</label>
                                        <input type="text" onChange={this.oncgangeob} className={`form-control ${this.state.invob}`} id="obem"
                                               placeholder="Объем" value={this.state.inpob} />
                                        <div className={this.state.clasob}>
                                            {this.state.erorob}
                                        </div>
                                    </div>
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="ypakovka">Упаковка</label>
                                        <input type="text" className={`form-control ${this.state.invyp}`} id="ypakovka"
                                               placeholder="Упаковка" onChange={this.oncgangeyp} value={this.state.inpyp} />
                                        <div className={this.state.clasyp}>
                                            {this.state.eroryp}
                                        </div>
                                    </div>
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="srok">Срок хранения</label>
                                        <input type="text" className={`form-control ${this.state.invsrok}`} id="srok"
                                               placeholder="Срок хранения" onChange={this.oncgangesrok} value={this.state.inpsrok} />
                                        <div className={this.state.classrok}>
                                            {this.state.erorsrok}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="form-row">
                                    <div className="col-md-12 mb-3">
                                        ...
                                        <textarea className={`form-control ${this.state.invtext}`} onChange={this.oncgangetext} id="text" rows="3" value={this.state.inptext}/>
                                        <div className={this.state.clastext}>
                                            {this.state.erortext}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="form-row">
                                    <div className="col-md-3 mb-3">
                                        ...
                                        <input type="text" className={`form-control ${this.state.invsena}`} onChange={this.oncgangesena} id="sena"
                                               placeholder="Цена за еденицу" value={this.state.inpsena} />
                                        <div className={this.state.classena}>
                                            {this.state.erorsena}
                                        </div>
                                    </div>
                                    <div className="col-md-3 mb-3">
                                        <label htmlFor="sena2">Цена за еденицу в упаковке</label>
                                        <input type="text" className={`form-control ${this.state.invsena2}`} onChange={this.oncgangesena2} id="sena2"
                                               placeholder="Цена за еденицу в упакоовке" value={this.state.inpsena2} />
                                        <div className={this.state.classena2}>
                                            {this.state.erorsena2}
                                        </div>
                                    </div>
                                    <div className="col-md-3 mb-3">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="text" className={`form-control ${this.state.invkol}`}
                                                   id="kol" placeholder="Количество едениц в упаковке" onChange={this.oncgangekol} value={this.state.inpkol}
                                            />
                                            <div className={this.state.claskol}>
                                                {this.state.erorkol}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="form-row">
                                    <div className="col-md-4 mb-3">
                                        ...
                                        <input type="file" className="form-control-file" multiple  onChange={this.onchagefile}  id="file"/>
                                    ...
                                    <div className="col-md-3 mb-3">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <select className="form-control" onChange={this.oncgangecat} id="cat">
                                                <option value="nan" selected>Выберите категорию </option>
