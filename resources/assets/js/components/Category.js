...
import  FornmZakaz from './component/Formzakaz'
...
export default class Category extends React.Component {
    constructor(props) {
        super(props);
        this.state = {array:[],valtovar:0, senarr:[],Sena:0} ;
        ...
        return(
            <section className="content ">
                ...
                <div className="container content-fon ">
                    <FornmZakaz func={this.funcarr}  fullsena ={this.fullsaena} id={this.props.match.params.id} />
