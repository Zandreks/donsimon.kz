    ...
    list(){
        const list = this.state.img.map(number =>
            <div key={number} className="col-4">
                <a data-fancybox="gallery" href={`/img/sokis/${number}`}><img
                    src={`/img/sokis/${number}`} className="img-pr img-thumbnail "/></a>
                        ...
                        <div className="col-md-4">
                            <div className="product-galer ">
                                <div className="img-prduc">
                                    <a data-fancybox="gallery" href={`/img/sokis/${this.state.img[0]}`}><img
                                        src={`/img/sokis/${this.state.img[0]}`} className="img-pr img-thumbnail "/></a>
                        ...
                        <div className="col-md-8">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="">
                                        <p>
                                            {(this.state.data.sklad === 1) ? <span className="alert alert-success" >Есть в наличии</span> :<span className="alert alert-danger" >Нет в наличии</span> }
                                        </p>
                                    </div>
                                    <div className="text-poduct">
                                        ...
                                        <div className='row'>
                                            <div className='col-md-6'>
                                                <p className='zametkabold'>
                                                    Артикул
                                                </p>
                                                <p>
                                                    {this.state.data.articl}
                                                </p>
                                            </div>
                                            <div className='col-md-6'>
                                                <p className='zametkabold'>
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="tab-content pb-4" id="myTabContent">
                                <div className="tab-pane fade show active" id="home" role="tabpanel"
                                     aria-labelledby="home-tab">{this.state.data.opisan}
                                </div>
